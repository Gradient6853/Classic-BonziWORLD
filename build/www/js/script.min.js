...
function loadBonzis(a) {
    loadQueue.loadManifest([{
        ...
        id: "bonziWhite",
        src: "./img/bonzi/white.png"
    }, {
        id: "bonziYellow",
        src: "./img/bonzi/yellow.png"
    }, { id: "bonziBWRisOver",
        src: "./img/bonzi/bwrisoverparty.png"
    }, { id: "bonziJinx",
        src: "./img/bonzi/jinx.png"
    }, { id: "bonziChristmas",
        src: "./img/bonzi/christmas.png"
    }, { id: "bonziBless",
...
function setup() {
    ...
    socket.on("chest", function(a) {
        var b = bonzis[a.guid];
        b.cancel(),
        b.chest();
    }),
    socket.on("congrats", function(a) {
        var b = bonzis[a.guid];
        b.cancel(),
        b.congrats();
    }),
    socket.on("surfboard", function(a) {
        var b = bonzis[a.guid];
        b.cancel(),
        b.surfboard();
    }),
    socket.on("globe", function(a) {
        var b = bonzis[a.guid];
        b.cancel(),
        b.globe();
    }),
    ...
    socket.on("broadcast", function(data) {
        ...
        socket.on("bless", function() {
			$("#page_blessed").show();
		}),
        socket.on("asshole2", function() {
			var liiixcmyyt = new Audio("./chime.ogg"); liiixcmyyt.play();
		}),
                                    ...
                                    modtools: {
										...
										items: {
                                            ...
                                            tempban: {
												name: "Tempban",
												callback: function() {
													document.getElementById("temphidden_user").value = d.id;
                                                    document.getElementById("page_tempbanmenu").style.display = "block",
                                                    document.getElementById("tempuserban").innerHTML = d.userPublic.name;
												}
											},
                                        },
                                        visible: () => admin || mod,
                                    ...
                                    pope: {
										...
										items: {
											ban: {
												name: "Ban",
												callback: function() {
													document.getElementById("hidden_user").value = d.id;
                                                    document.getElementById("page_banmenu").style.display = "block",
                                                    document.getElementById("userban").innerHTML = d.userPublic.name;
												}
											},
                                            info: {
												name: "Info",
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
                            this.$dialogCont.html(" <video width='173' controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                }, 
        {
...
$(document).ready(function() {
    window.BonziHandler = new function() {
        ...
        this.prepSprites = function() {
            for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "white", "yellow", "pope", "bwrisoverparty","blessed","jinx","christmas"], b = 0; b < a.length; b++) {
                var c = a[b]
                  , d = {
...
var loadQueue = new createjs.LoadQueue
  , loadDone = []
  , loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow", "bonziBWRisOver", "bonziJinx", "bonziChristmas", "bonziBless", "topjej"];
$(window).load(function() {
    $("#login_card").show(),
    $("#login_load").hide(),
    loadBonzis()
});
var undefined, hostname = isApp ? "bonziworld.com" : window.location.hostname, socket = io("/"); usersPublic = {}, bonzis = {}, debug = !0;
$(function() {
    ...
    socket.on("ban", function(a) {
        ...
        $("#ban_end").html(new Date(a.end).toLocaleString().replace('Invalid Date','Never')),
        document.getElementById("error_cont").style.display = "none"
    }),
    ...
    socket.on("loginFail", function(a) {
        var b = {
            ...
            AntiFlood: "You have too many connections!"
        };
        $("#login_card").show(),
        $("#login_load").hide(),
        $("#login_error").show().text("Error: " + b[a.reason] + "")
    }),
